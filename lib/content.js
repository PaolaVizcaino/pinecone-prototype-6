...
export const questions = {
  ...
  'build-a-budget': {
    ...
    title: "How does Grace make a budget she'll actually stick to?",
    short: 'Build a budget',
    situation: 'getting-organized',
    minutes: 8,
    blurb: "Follow Grace's numbers, then see what her saving could become over time.",
    game: { kind: 'local', src: '/games/budget-board.html?grace=1', name: "Grace's budget", wide: true },
    story: {
      who: 'Grace',
      lines: ['Grace is a dental hygienist with a steady paycheck of $4,300 a month after taxes.', 'Her job comes with good benefits, including a 401(k) she pays into every month.', 'She is still paying off her own student loans, and she helps her partner cover his tuition.', 'She wants a budget that reflects her real life and moves her toward her goals.'],
