...
export const questions = {
  ...
  'build-a-budget': {
    ...
    blurb: "her budget doesn't balance yet. Help her adjust it and find out if there is room to build an emergency fund.",
    game: { kind: 'local', src: '/games/budget-board.html?grace=1', name: "Grace's budget" },
    story: {
      who: 'Grace',
      role: 'Dental hygienist',
      photo: '/grace.jpg',
      facts: ['Steady paycheck: $4,300 a month after taxes', 'Good benefits, including a 401(k) she pays into every month', 'Still paying off her student loans', 'Helps her partner with his tuition'],
      goal: "Right now, more goes out than goes in. Grace wants to build an emergency fund so she doesn't need to charge unexpected expenses to her credit card. She needs to make a budget.",
    },
