  ...
  'build-a-budget': {
    ...
    learn: {
      idea: [
        ...
        'A good budget is well planned, organized in a way you will keep using, and adaptable when life changes.',
      ],
      more: [
        { title: 'Steps for developing a budget', intro: 'Now that you understand how money flows in and out, you can create a budget that works for your lifestyle. You can use the following seven steps:', ordered: true, items: [
        ...
        { title: 'Where can you cut back?', intro: 'If your cash flow is negative or saving feels impossible, look for areas to reduce spending:', items: [
        ...
        ], outro: 'Even small adjustments add up, helping you turn negative cash flow positive and freeing up money for savings or debt reduction.' },
      ],
      terms: [
    ...
    minutes: 8,
    cardBlurb: 'Enter your monthly numbers, see where your money goes, and find out if there is room to save.',
    blurbLead: 'Meet Grace:',
    blurb: "her budget doesn't balance yet. Help her adjust it.",
    game: { kind: 'local', src: '/games/budget-board.html?grace=1', name: "Grace's budget" },
    story: {
      who: 'Grace',
      role: 'Dental hygienist',
      photo: '/grace.jpg',
      facts: ['Steady paycheck: $4,300 a month after taxes', 'Good benefits at work', 'Still paying off her student loans', 'Helps her partner with his tuition'],
      goal: "Grace built a budget from last month's expenses and found she's already spending more than she earns, before even setting aside anything for an emergency fund. Help her balance her budget.",
    },
    video: { title: 'Watch Grace build her budget', lead: 'Watch Grace go through the steps to create her budget.', note: 'Video from Module 2, Lesson 3. Embed the Mighty video here for testing.' },
    research: true,
    ideas: [
