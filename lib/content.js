...
export const questions = {
  ...
  'build-a-budget': {
    ...
    learn: {
      ...
      more: [
        { title: 'Steps to developing a budget', intro: 'Now that you understand how money flows in and out, you can create a budget that works for your lifestyle. You can use the following seven steps:', ordered: true, items: [
